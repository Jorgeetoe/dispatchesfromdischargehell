---
layout: post
title: "Part 4: The DME Delivery Black Hole"
date: 2024-01-12
...
description: "We ordered the hospital bed two weeks ago. Week three, discharge day: the bed is ready and delivered, but the pressure-relief cushion is delayed due to sizing. "
redirect_from:
...
The CM orders the suction machine. The therapists own the wheelchair order. Both have to land on the same date. The case manager and social worker track both streams with the intensity of a countdown clock across two vendors, two authorization tracks, converging on the same date.
