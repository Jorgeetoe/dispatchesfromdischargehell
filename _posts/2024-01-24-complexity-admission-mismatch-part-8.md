---
layout: post
title: "Dispatches from Discharge Hell, Part 8: The Complexity-Admission Mismatch"
date: 2025-04-14
...
We sit in the middle of this contradiction every single day.
...
Other weeks the unit is full of patients who can't leave — not because they're not ready, but because there's nowhere for them to go. Every bed is occupied by a patient whose discharge plan depends on a variable I can't control. And the transfer coordinator is calling with three more patients waiting in acute care.
...
We've never heard anyone in leadership say, "We shouldn't have admitted that patient." The mission is real. The commitment is real.

But we've also never heard anyone say, "The discharge timeline for this patient should be different because of the complexity we accepted at admission." The financial model doesn't flex for the mission. The case manager and social worker are expected to.
