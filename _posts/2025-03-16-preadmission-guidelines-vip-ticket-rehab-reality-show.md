...
Our outcomes conversations often feature an invisible graph showing "Patient Progress" and "Insurance Coverage" as two lines moving in opposite directions. It's funny because it's painfully true.
...
The most therapeutic conversation we can have during orientation is titled "Adjusting Your Expectations Without Abandoning Hope." It's consistently our most-requested session.
...
The therapeutic value of a "Marketplace Insurance Support Group" would be immeasurable – where the only activity is collective screaming into the void.
