---
layout: post
title: "Home Health Is Not Home Care: What Families Should Know Before Discharge"
date: 2025-04-26
categories: [field-notes]
author: Jorge Arenivar
description: >-
  A family-facing guide explaining why home health is not the same as home care,
  what services may actually show up after discharge, how long home health may
  last, and what families should ask before relying on it as the safety plan.
excerpt: "Home health is not home care."
tags: [home-health, home-care, discharge-planning, caregiver-readiness, caregiver-training, catastrophic-injury, brain-injury, rehab-discharge, private-duty-nursing, post-acute-care, family-education]
keywords: "home health is not home care, home health after rehab discharge, what does home health cover, home health catastrophic injury, home health after brain injury"
toc: true
redirect_from:
  - /blog/posts/2025-04-26-home-health-is-not-home-care-before-discharge.html
---
...
1. **Which home health agency has accepted?**
2. **Has the agency reviewed the actual clinical needs?**
3. **Which services are ordered?**
4. **How many visits per week from each discipline?**
5. **How long is each visit?**
6. **What is the expected start-of-care date?**
7. **Is a home health aide included?**
8. **What services are not covered?**
9. **Who handles nights and weekends?**
10. **Who do we call after hours?**
11. **What response can we expect after hours?**
12. **What equipment or supplies must be in the home before the first visit?**
13. **What training must happen before discharge because home health will not be there continuously?**
14. **What is the backup plan if the agency declines after reassessment?**
...
- [AHRQ: IDEAL Discharge Planning](https://www.ahrq.gov/patient-safety/patients-families/engagingfamilies/strategy4/index.html): supports involving families throughout discharge planning, discussing what life at home will require, and using teach-back.
- [AHRQ PSNet: Discharge Planning and Transitions of Care](https://psnet.ahrq.gov/primer/discharge-planning-and-transitions-care): frames discharge and care transitions as patient-safety risk points requiring coordination and communication.
- [Medicare home health coverage](https://www.medicare.gov/coverage/home-health-services): explains Medicare's part-time or intermittent home health limits and the distinction between covered home health services and needs that exceed intermittent skilled care.
- [CGS Medicare: Home Health Certification/Recertification Requirements](https://www.cgsmedicare.com/hhh/cert/hh_cert_requirements.html): explains that physician recertification is required at least every 60 days when continuous home health care is needed after the initial episode.
- [Medicare Rights Center: Understanding Medicare Home Health Care](https://www.medicarerights.org/medicare-answers/2026/01/28/understanding-medicare-home-health-care): explains that Medicare home health is not generally long-term care and that a plan of care/certification can be renewed in additional 60-day periods as needed.
- [Caregiver Inclusion in IDEAL Discharge Teaching](https://pmc.ncbi.nlm.nih.gov/articles/PMC9177052/): supports the need for active caregiver preparation, problem-solving, and support after discharge.
- [Current Practices of Family Caregiver Training During Home Health Care](https://pmc.ncbi.nlm.nih.gov/articles/PMC8742751/): notes that home health agencies must provide caregiver training as needed but that training practices vary.
- [Family Caregiver Alliance: Hospital Discharge Planning Guide](https://www.caregiver.org/resource/hospital-discharge-planning-guide-families-and-caregivers/): caregiver-facing guide supporting practical discharge questions and family preparation.
