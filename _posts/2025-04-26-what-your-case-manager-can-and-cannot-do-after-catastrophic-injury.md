...
- [AHRQ — IDEAL Discharge Planning Implementation Handbook](https://www.ahrq.gov/sites/default/files/wysiwyg/professionals/systems/hospital/engagingfamilies/strategy4/Strat4_Implement_Hndbook_508_v2.pdf): frames discharge as a process, not a single event, and emphasizes coordinated planning with patients and families.
- [CMS — 42 CFR § 482.43, Condition of Participation: Discharge Planning](https://www.ecfr.gov/current/title-42/chapter-IV/subchapter-G/part-482/subpart-C/section-482.43): requires hospitals to identify patients at risk for adverse health consequences without adequate discharge planning and to complete timely discharge-planning evaluations.
- [CMS — Discharge Planning Rule Supports Interoperability and Patient Preferences](https://www.cms.gov/newsroom/fact-sheets/cms-discharge-planning-rule-supports-interoperability-and-patient-preferences): emphasizes patient goals, treatment preferences, and preparation for post-acute care needs.
- [CMSA — Standards of Practice for Case Management](https://cmsa.org/about/standards-of-case-management-practice/): provides professional standards for case management practice, including coordination, advocacy, resource navigation, communication, and transition support.
- [NASW — Standards for Social Work Practice in Health Care Settings](https://www.socialworkers.org/Practice/NASW-Practice-Standards-Guidelines/NASW-Standards-for-Social-Work-Practice-in-Health-Care-Settings): describes health care social work responsibilities including psychosocial support, access to resources, continuity of care, and safe discharge.
- [National Academies — Families Caring for an Aging America](https://www.nationalacademies.org/publications/23606): documents the central role and burden of family caregivers and the need for better support, training, and system recognition.
