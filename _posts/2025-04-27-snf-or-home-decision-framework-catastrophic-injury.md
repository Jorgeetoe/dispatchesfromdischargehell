---
layout: post
title: "SNF or Home? A Real Decision Framework for Families After Catastrophic Injury"
date: 2025-04-27
categories: [field-notes]
author: Jorge Arenivar
description: >-
  A family-facing decision framework for choosing between skilled nursing
  facility placement and home discharge after catastrophic injury, including
  caregiver capacity, insurance timing, home health limits, SNF bridge
  realities, and hidden discharge traps.
excerpt: "SNF versus home is not a moral test. It is a capacity question."
tags: [snf-vs-home, skilled-nursing-facility, home-discharge, discharge-planning, caregiver-readiness, home-health, rehab-benefits, insurance-authorization, post-acute-care, catastrophic-injury, family-education]
keywords: "SNF vs home after brain injury, skilled nursing facility or home care, discharge planning family decision, caregiver decision after rehab, home health is not home care"
toc: true
redirect_from:
  - /blog/posts/2025-04-27-snf-or-home-decision-framework-catastrophic-injury.html
---
...
Home discharge is also a supply chain. Briefs, gloves, wipes, trach supplies, feeding tube supplies, wound care supplies, positioning items, and communication tools may not all be covered or ready on day one. See [**The Supply Bill Nobody Mentions Before Home Discharge**]({% post_url 2025-04-25-supply-bill-nobody-mentions-before-home-discharge %}).
...
- **Related reading:** [Home Health Is Not Home Care]({% post_url 2025-04-26-home-health-is-not-home-care-before-discharge %}); [The Supply Bill Nobody Mentions Before Home Discharge]({% post_url 2025-04-25-supply-bill-nobody-mentions-before-home-discharge %}); [When SNF Becomes Long-Term Care]({% post_url 2025-04-25-when-snf-becomes-long-term-care %}); [What Actually Drives the Discharge Date?]({% post_url 2025-04-27-what-actually-drives-the-discharge-date %}); [Family Training Is Not the Same as Family Readiness]({% post_url 2025-04-23-family-training-is-not-family-readiness %}); Why No Facility Will Accept My Loved One; The Discharge Plan Assumes a Family That Doesn't Exist.

## Selected evidence and practice references

- [AHRQ: IDEAL Discharge Planning](https://www.ahrq.gov/patient-safety/patients-families/engagingfamilies/strategy4/index.html): supports including patients and families as partners, discussing what life at home will require, reviewing medications and follow-ups, and using teach-back.
- [AHRQ PSNet: Discharge Planning and Transitions of Care](https://psnet.ahrq.gov/primer/discharge-planning-and-transitions-care): frames discharge and care transitions as patient-safety risk points requiring coordination, communication, medication safety, and stakeholder involvement.
- [CMS: 42 CFR § 482.43, Condition of Participation: Discharge Planning](https://www.ecfr.gov/current/title-42/chapter-IV/subchapter-G/part-482/subpart-C/section-482.43): requires hospitals to maintain an effective discharge-planning process and involve patients and caregivers/support persons as active partners.
- [CMS: Skilled Nursing Facility Services](https://www.cms.gov/training-education/medicare-learning-networkr-mln/compliance/medicare-provider-compliance-tips/skilled-nursing-facility-services): clarifies that SNF coverage requires skilled services and does not cover custodial care alone.
- [KFF: Medicare spending on skilled nursing facilities during COVID-19](https://www.kff.org/medicare/amid-the-covid-19-pandemic-medicare-spending-on-skilled-nursing-facilities-increased-more-than-4-despite-an-overall-decline-in-utilization/): reports that average traditional Medicare SNF stays were 24.7 days in 2019 and 26.3 days in 2020, useful context for explaining that SNF bridges are often measured in weeks, not months.
- [Family Caregiver Alliance: Hospital Discharge Planning: A Guide for Families and Caregivers](https://www.caregiver.org/resource/hospital-discharge-planning-guide-families-and-caregivers/): practical caregiver-facing discharge planning guide that supports early planning, direct questions, and caregiver readiness.
- [United Hospital Fund: Rehab-to-Home Discharge Guide](https://media.uhfnyc.org/filer_public/d9/f8/d9f8b52d-5267-47b2-bde7-868780eae9ac/4_uhf_next_step_in_care__rehab-to-home_discharge_guide.pdf): useful family-facing guide for the transition from rehab to home.
- [NCBI Bookshelf / StatPearls: Discharge Planning](https://www.ncbi.nlm.nih.gov/books/NBK557819/): summarizes discharge planning as transition from one level of care to another and links inadequate planning to readmission and quality-of-life risk.
- [Caregiver Inclusion in IDEAL Discharge Teaching](https://pmc.ncbi.nlm.nih.gov/articles/PMC9177052/): caregiver experiences suggest limited, passive involvement in discharge education can contribute to problems after discharge; supports assessing caregiver problem-solving, planning, and post-discharge support.
- [Current Practices of Family Caregiver Training During Home Health Care](https://pmc.ncbi.nlm.nih.gov/articles/PMC8742751/): notes that CMS home health Conditions of Participation require training and education for family caregivers as needed, while practical guidance on modality, frequency, and content remains limited.
- [Medicare home health coverage](https://www.medicare.gov/coverage/home-health-services): explains Medicare's part-time or intermittent home health limits and notes that people who need more than part-time or intermittent skilled care generally do not qualify for the home health benefit.
- [CGS Medicare: Home Health Certification/Recertification Requirements](https://www.cgsmedicare.com/hhh/cert/hh_cert_requirements.html): explains that recertification is required at least every 60 days when continuous home health care is needed after the initial episode.
- [UC Davis: Family Caregiver Domains of Preparedness](https://health.ucdavis.edu/media-resources/family-caregiving/documents/pdfs/FCI-Domains-of-Preparedness-080221.pdf): useful framework for separating willingness from preparedness across medical/nursing tasks, safety, emotional readiness, and coordination.
