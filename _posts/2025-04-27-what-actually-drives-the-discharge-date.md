...
- [AHRQ — IDEAL Discharge Planning Implementation Handbook](https://www.ahrq.gov/sites/default/files/wysiwyg/professionals/systems/hospital/engagingfamilies/strategy4/Strat4_Implement_Hndbook_508_v2.pdf): states that discharge is not a one-time event, but a process throughout the hospital stay, and emphasizes early family/caregiver involvement.
- [CMS — 42 CFR § 482.43, Condition of Participation: Discharge Planning](https://www.ecfr.gov/current/title-42/chapter-IV/subchapter-G/part-482/subpart-C/section-482.43): requires hospitals to maintain an effective discharge-planning process, involve patients and caregivers/support persons as active partners, and help select post-acute providers using relevant quality and resource-use data.
- [CMS — Discharge Planning Rule Supports Interoperability and Patient Preferences](https://www.cms.gov/newsroom/fact-sheets/cms-discharge-planning-rule-supports-interoperability-and-patient-preferences): emphasizes patient goals, treatment preferences, and preparation for post-acute care needs across hospitals, IRFs, LTCHs, CAHs, and home health agencies.
- [CMS — Inpatient Rehabilitation Facility Medical Necessity and Documentation Requirements](https://www.cms.gov/research-statistics-data-and-systems/monitoring-programs/medicare-ffs-compliance-programs/recovery-audit-program/approved-rac-topics-items/0073-inpatient-rehabilitation-facility-irf-stays-meeting-requirements-to-be-considered-reasonable-and-necessary-): describes IRF care as reasonable and necessary when the patient’s medical, nursing, and rehabilitation complexity requires an intensive inpatient rehabilitation environment and interdisciplinary team approach.
- [CMS — 42 CFR § 412.622, IRF interdisciplinary team requirements](https://www.ecfr.gov/current/title-42/chapter-IV/subchapter-B/part-412/subpart-P/section-412.622): defines the required IRF interdisciplinary team structure, including the rehabilitation physician, rehabilitation nurse, social worker or case manager, and involved therapy disciplines.
- [CMS — IRF Review Choice Demonstration Review Guidelines](https://www.cms.gov/files/document/irf-rcd-review-guidelines.pdf): describes IRF medical-necessity review concepts including the overall plan of care, therapy intensity, interdisciplinary team input, and documentation of expected functional outcomes and discharge destination.
- [CMS — Inpatient Rehabilitation Hospitals & Inpatient Rehabilitation Units Compliance Tips](https://www.cms.gov/training-education/medicare-learning-networkr-mln/compliance/medicare-provider-compliance-tips/inpatient-rehabilitation-hospitals): identifies medical necessity and documentation as major drivers of IRF payment review and denial risk.
- [CMS — Skilled Nursing Facility Services](https://www.cms.gov/training-education/medicare-learning-networkr-mln/compliance/medicare-provider-compliance-tips/skilled-nursing-facility-services): clarifies that SNF coverage requires skilled services and does not cover custodial care alone, which matters when families are comparing SNF, home, and inpatient rehab pathways.
- [AHRQ PSNet — Discharge Planning and Transitions of Care](https://psnet.ahrq.gov/primer/discharge-planning-and-transitions-care): summarizes discharge and care transitions as patient-safety risk points requiring coordination, medication safety, communication, and stakeholder involvement.
