---
title: "Part 5: The Home Health Illusion"
date: 2024-01-15T00:00:00Z
categories: ["Dispatches"]
series: "Dispatches from Discharge Hell"
series_order: 5
description: "The family heard 'home health' and exhaled. Finally, a plan that sounded like help. A nurse visits twice a week for 45 minutes. Between those visits, the family is alone 23 hours a day. That gap is the single biggest source of post-discharge frustration in catastrophic care."
related: ["/blog/posts/2024-01-15-home-health-illusion-part-5/", "/blog/posts/2024-01-15-home-health-illusion-part-5/", "/blog/posts/2024-01-15-home-health-illusion-part-5/"]
---

*Dispatches from Discharge Hell — A 25-Part Series on the Patterns Nobody Warns You About*
The family heard "home health" and exhaled.
...
That gap is the single biggest source of post-discharge frustration in catastrophic care. I've seen it hundreds of times. [The caregiver burden that results](/blog/posts/2025-02-21-permission-to-rest.html) is often invisible until it becomes unmanageable.

For catastrophic neuro patients (severe TBI, spinal cord injury, disorders of consciousness), the only home health agencies that provide comparable post-acute support are specialty neuro programs, if they exist. They're expensive. They're limited in geography. They're often not covered by the patient's insurance.
...
Sound familiar? This reversal pattern is the same mechanism we see in [The Ghost SNF](/blog/posts/2024-01-09-ghost-snf-part-3.html), just wearing a different uniform.
I stopped depending on home health for our patients a long time ago.
That sounds harsh. It's not cynicism: it's the conclusion you reach after watching the same pattern repeat across years of cases. For grandma with a hip fracture, home health works fine. It's what the system was built for.
For a patient with a severe TBI, a trach, behavioral episodes, and a family that just learned how to do a catheterization last Tuesday? Home health is going to show up twice a week for 45 minutes and leave a note.
That's not a safety net. That's a checkbox.

So what is the safety net?

          
It is the training. The actual hands-on, demonstrated-competency, return-demonstration training that happens before discharge. That's the real safety net. The caregiver who can do the catheterization at 2 AM. The caregiver who recognizes the signs of aspiration. The caregiver who knows when to call 911 versus when to call the nurse line.
I set expectations early now: *Home health will not replicate what you've had here. The training you do before discharge is what keeps your family member safe at home. The home health nurse will check in. But the daily care — that's you.*
...
*Next in the series: Part 6 — "We're Going to Keep Praying." What happens when a family's deepest convictions meet the discharge planning timeline.*
